...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100082523448333')
...
TOOLS UPDATE DN BY MASOOM SALMAN

/FACEBOOK PAGE KA LINK DEYA HAI NEW UPDATES KELEYE FOLLOW ZAROR KARNA <::::::::::::::::[]

/FOLLOW KARKE IB SS DENA APKO 1 ID MELEGA 

 ______________________________________________

 Author   :            MasOom SaLmaN

 Facebook :         Masoom SalmaN khan

 Facebook page   :        https://www.facebook.com/profile.php?id=100082523448333
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  MASOOM-Ok  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  MASOOM-Cp ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  MASOOM-Ok ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  SALMAN-OK  ' + k + c + user + '  |  ' + pass3
                        ...
                        print '\x1b[1;92m  MasoomI-Cp ' + k + c + user + '  |  ' + pass3
